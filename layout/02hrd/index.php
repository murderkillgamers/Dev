...
if(isset($submodulId))
{
    ...
    if($row["Count"])
    {
        if($submodulId == 2){echo "<title>Human Resource Department - Employee Data</title>";include("layout/02hrd/02employeedata.php");}
    }
    else
    {?>
...
{
    echo "<title>Human Resource Department</title>";
    include("layout/02hrd/main.php");
}
